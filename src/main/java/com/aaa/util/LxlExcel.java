            ...
            for (int numSheet = 0; numSheet < numberOfSheets; numSheet++) {
                ...
                for (int rowNum = 1; rowNum <= lastRowNum; rowNum++) {
                    ...
                    if (row == null) {
                        ...
                        try {
                            XSSFCell createtime = row.getCell(0);
                            XSSFCell recordname = row.getCell(1);
                            XSSFCell numbers= row.getCell(2);
                            XSSFCell degree = row.getCell(3);
                            XSSFCell endtime = row.getCell(4);
                            XSSFCell sort = row.getCell(5);
                            XSSFCell userid = row.getCell(6);
                            XSSFCell describes = row.getCell(7);
                            XSSFCell way = row.getCell(8);
                            XSSFCell content = row.getCell(9);
                            XSSFCell recordid = row.getCell(10);
                            XSSFCell result = row.getCell(11);
                            XSSFCell endid = row.getCell(12);
                            XSSFCell customerid = row.getCell(13);
                            XSSFCell opinions = row.getCell(14);
                            XSSFCell endname = row.getCell(15);
                            XSSFCell theme = row.getCell(16);
                            XSSFCell comment = row.getCell(17);
                            XSSFCell id = row.getCell(18);
                            XSSFCell customername = row.getCell(19);
                            XSSFCell isdel = row.getCell(20);
                            XSSFCell connections = row.getCell(21);
                            XSSFCell username = row.getCell(22);
                            XSSFCell status = row.getCell(23);
